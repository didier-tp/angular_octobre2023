...
@Component({
  selector: 'app-devise2S',
  templateUrl: './devise2.component.html',
  styleUrls: ['./devise2.component.scss']
})
export class DeviseComponent2 implements OnInit {
  ...
  onSelectDevise(d : Devise ){
    ...
    //directement un des objets du tableau this.tabDevises
      ...
      //this.deviseTemp = this.selectedDevise;
